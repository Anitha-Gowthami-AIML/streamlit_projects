...
# Use your raw GitHub URL for the background image
...
# MODEL INPUT
# -------------------------------------------------------
input_data = np.array([[age, gender_val, bmi, children, smoker_val,
...
if st.button("Predict Insurance Cost"):
    ...
    if hasattr(model, "feature_importances_"):
        ...
        features = ["Age", "Gender", "BMI", "Children", "Smoker", "Northwest", "Southeast", "Southwest"]
